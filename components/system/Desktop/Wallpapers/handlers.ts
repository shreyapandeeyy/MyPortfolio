...
import { MILLISECONDS_IN_DAY, MILLISECONDS_IN_MINUTE } from "utils/constants";
import {
jsonFetch,
viewWidth,
isYouTubeUrl,
...
    },
    };
    const response = (await fetch(API_URL.ART_INSTITUTE_OF_CHICAGO, {
    body: JSON.stringify(requestPayload),
    headers: {
        "Content-Type": "application/json",
    },
    method: "POST",
    }).then(res => res.json())) as ArtInstituteOfChicagoResponse;
...
    newWallpaperFit: "fit",
    updateTimeout: MILLISECONDS_IN_MINUTE * 60,
