...
 * */
const nextConfig = {
  // Ensure we're NOT using static export since we have API routes
  // output: 'standalone', // Uncomment if you want to optimize for Docker/serverless
  eslint: {
    // Avoid failing the Vercel build on lint errors; keep linting locally
